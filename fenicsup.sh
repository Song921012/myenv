...
conda update --all
pip install Numpy Pandas Matplotlib scipy sympy statsmodels jupyter radian flake8 pylint yapf virtualenv rich pygments jupyter_contrib_nbextensions nbconvert hippylib"[notebook]"
...
## Remove
#pip uninstall fenics-basix fenics-ffcx fenics-ufl pyvista fenics-dolfinx
