...
pip install -U radian conan flake8 pylint yapf huggingface-hub\
  ...
  funsor ott distrax neural-tangents efax dm-haiku pyMetaheuristic diffrax jaxopt evosax sgmcmcjax gpjax blackjax\
  pyecharts plotly dash "sktime[all_extras]" nodepy seaborn keplergl osmnx pyecharts_snapshot\
