...
pip install -U radian conan flake8 pylint yapf\
  ...
  pyomo gekko dymos leafmap darts pydeck nlopt optax flax numpyro jaxns funsor ott distrax efax diffrax jaxopt sgmcmcjax gpjax blackjax pyecharts plotly dash sklearn "sktime[all_extras]"
