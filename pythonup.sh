...
pip install -U radian conan flake8 pylint yapf huggingface-hub\
  ...
  pyomo gekko dymos leafmap darts pydeck nlopt optax flax numpyro jaxns funsor ott distrax neural-tangents efax dm-haiku pyMetaheuristic diffrax jaxopt evosax sgmcmcjax gpjax blackjax pyecharts plotly dash "sktime[all_extras]" nodepy seaborn keplergl osmnx pyecharts_snapshot biopython mesa quadpy
